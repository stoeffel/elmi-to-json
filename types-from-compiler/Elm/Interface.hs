...
instance Aeson.ToJSON Union where
  toJSON (OpenUnion u) = Aeson.toJSON u
  toJSON (ClosedUnion u) = Aeson.toJSON u
  toJSON (PrivateUnion u) = Aeson.toJSON u


instance Aeson.ToJSON Alias where
  toJSON (PublicAlias a) = Aeson.toJSON a
  toJSON (PrivateAlias a) = Aeson.toJSON a
